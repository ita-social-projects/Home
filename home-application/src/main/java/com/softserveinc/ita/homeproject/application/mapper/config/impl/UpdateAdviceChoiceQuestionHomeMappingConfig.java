...
public class UpdateAdviceChoiceQuestionHomeMappingConfig
    implements HomeMappingConfig<UpdateAdviceQuestion, PollQuestionDto> {
    @Lazy
    private final HomeMapper homeMapper;

    @Override
    public void addMappings(TypeMap<UpdateAdviceQuestion, PollQuestionDto> typeMap) {
