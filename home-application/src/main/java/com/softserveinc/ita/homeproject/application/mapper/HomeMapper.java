...
public class HomeMapper {
    ...
    private Map<Class, Class> customTypeMappingMap = new HashMap<>();
    {
    ...
    public void init() {
        ...
        ConditionalConverter<Object, BaseDto> conditionalConverter = new AbstractTypeConverter<>(MODEL_PACKAGE, DTO_PACKAGE, (s, d) -> {
            ...
            return destinationSimpleName.contains(sourceSimpleDomainName) || sourceSimpleDomainName.contains(destinationSimpleName);
        });
        ConditionalConverter<BaseDto, Object> conditionalConverter2 = new AbstractTypeConverter<>(DTO_PACKAGE, MODEL_PACKAGE, (s, d) -> {
            if (customTypeMappingMap.containsKey(s)) {
                return d.equals(customTypeMappingMap.get(s));
            }
