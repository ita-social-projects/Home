...
@Component
public class ApartmentRSQLEndpointConfig implements RSQLEndpointConfig <Apartment, ApartmentQueryConfig.ApartmentQueryParamEnum> {
    ...
    public Map<ApartmentQueryConfig.ApartmentQueryParamEnum, String> getMappings() {
        EnumMap<ApartmentQueryConfig.ApartmentQueryParamEnum, String> map = new EnumMap<>(ApartmentQueryConfig.ApartmentQueryParamEnum.class);
